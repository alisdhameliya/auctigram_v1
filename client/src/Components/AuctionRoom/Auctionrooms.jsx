        ...
        <div className="header flex justify-between items-center sm:pr-28 flex-wrap gap-4">
          ...
          >
            ...
            >
              {selectOption}{" "}
              <IoIosArrowDown
                className={`mt-1 transition-transform duration-500  ${showOptions ? "rotate-180" : ""
                  }`}
              />
            </div>
            <div
              className={`optionsConatiner top-14 absolute w-full left-0 rounded-xl z-50 overflow-hidden ${showOptions ? "block" : "hidden"
                }`}
              style={{
                backgroundColor: "rgba(7, 38, 67, 1)",
                boxShadow: "0 2.93px 3.67px 1.47px rgba(121, 197, 239, 0.38)",
